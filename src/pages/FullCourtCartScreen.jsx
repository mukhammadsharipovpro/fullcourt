...
import FullCourtCartItemComponent from '../components/FullCourtCartItemComponent';
import FullCourtComponent from '../components/FullCourtComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <FullCourtCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
